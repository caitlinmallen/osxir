/* Source: STrace: Dynamic Tracing in Oracle Solaris, Mac OS X, and FreeBSD by Brendan Gregg and Jim Mauro
#!/user/sbin/dtrace -s
...
syscall::connect*:entry
{
        ...
        this->s = (struct sockaddr_in *)copyin(argl, sizeof, (struct sockaddr));
...
/this->f == af_inet/
{
    ...
    /*Convert port to host byte order without ntohs() being avbailable *\
    self->port = (this->s->sin_port & 0xFF00) >> 8;
    self->port |= (this->s->sin_port & 0xF00) <<8;
    ...
    */
    this->a = (unit8_t *)&this->s->sin_addr;
