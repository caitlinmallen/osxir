  ...
  declare -a directories=(
    #list dirs to collect here, do not include a slash at the end
    "/var/audit"
  ) 
  #list of files you want to collect at the system level 
  declare -a files=(
    "/var/log/system.log"
...
declare -a userFiles=(
    #these are user files paths without the ~ at the beginning. Home directories will be connected later
    "Library/Preferences/com.apple.finder.plist"
    "Library/Preferences/com.apple.recentitems.plist"
    "Library/Preferences/com.apple.loginitems.plist"
    "Library/Logs/DiskUtility.log"
    "Library/Preferences/com.apple.LaunchServices.QuatantineEventsV2"
    ".bash_history"
    ".profile"
    ".bash_login"
    ".bash_logout"
